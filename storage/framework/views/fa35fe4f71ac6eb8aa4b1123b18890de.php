<footer class="" style="background-color: #f1ebdb;">
    <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div class="text-center">
            ...
            <p class="mx-auto mt-4 max-w-sm text-gray-500">
                We live, We love, Woi lah
            </p>

            <div class="mt-8 inline-block">
                <a href="/menu">
                    <?php echo $__env->make('component.buttonkeren', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </a>
            </div>
        </div>
...
</footer><?php /**PATH /Users/fidelbriandava/Documents/Genstore/Genstore-app/resources/views/component/footer.blade.php ENDPATH**/ ?>